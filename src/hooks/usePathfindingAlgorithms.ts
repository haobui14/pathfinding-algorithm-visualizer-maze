interface PathfindingAlgorithm {
  bfs: (startNode: number[], maze: string[][], onUpdateMaze: (maze: string[][]) => void, onComplete: (time: number, algorithm: string) => void, onSetTimeout: (id: number) => void) => void;
  dfs: (startNode: number[], maze: string[][], onUpdateMaze: (maze: string[][]) => void, onComplete: (time: number, algorithm: string) => void, onSetTimeout: (id: number) => void) => void;
}
